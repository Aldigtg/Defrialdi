...
public class MahasiswaJFrame extends javax.swing.JFrame {
    ...
    Connection Aldi = koneksi.KoneksiDatabase.BukaKoneksi(); //fungsi untuk melakukan koneksi ke database mysql
    ...
    private void Bersih(){
        txtkdmahasiswa.setText("");
        txtnama.setText("");
        txtalamat.setText("");
        txtprodi.setText("");
        txtusia.setText("");
        btnsimpan.setText("Simpan");
        txtkdmahasiswa.setEditable(true);
    }
    
    //fungsi untuk mencari data dari tabel di database mysql
    private void CariData(){
        try {
            st = Aldi.createStatement();
    ...
    private void initComponents() {
        ...
        txtkdmahasiswa = new javax.swing.JTextField();
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(txtkdmahasiswa, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsimpanActionPerformed
        ...
        try {
            ...
            if (txtkdmahasiswa.getText().equals("")|| 
            ...
            if (btnsimpan.getText()=="Simpan") {
                ...
                String cek ="SELECT * FROM tblmahasiswa WHERE kode = '" + txtkdmahasiswa.getText()+"'";
                rs = st.executeQuery(cek);
                if (rs.next()) {
                    JOptionPane.showMessageDialog(null,"Kode Mahasiswa Sudah dipakai");
                }else{
                    //fungsi untuk menyimpan data ke tabel
                    String sql = "INSERT INTO tblmahasiswa VALUES('" + txtkdmahasiswa.getText()+
                            "','"+txtnama.getText() +
                            "','"+txtalamat.getText() +
                            "','"+txtprodi.getText() + 
                            "','"+txtusia.getText() +"' )";
                ...
                String Update = "UPDATE tblmahasiswa SET nama ='" + txtnama.getText() +
                        ...
                        "' WHERE kode ='" +txtkdmahasiswa.getText()+"'";
    ...
    private void tbldataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbldataMouseClicked
        // TODO add your handling code here:
        txtkdmahasiswa.setText(tbldata.getValueAt(tbldata.getSelectedRow(), 1).toString());
        ...
        txtkdmahasiswa.setEditable(false);
        ...
        if (txtkdmahasiswa.getText().equals("")) {
            JOptionPane.showMessageDialog(this,"Pilih data yang ingin dihapus");
             ...
             if (jawab ==0) {
                 try {
                     st = Aldi.createStatement();
                     String sql = "DELETE FROM tblmahasiswa WHERE kode = '"+ txtkdmahasiswa.getText()+"'";
                     st.executeUpdate(sql);
    ...
    private javax.swing.JTextField txtkdmahasiswa;
